...
// Code Here
let doubled = myNumbers.map(function(elem) {
	return elem *2
})
//////////////////PROBLEM 15////////////////////
...
// Code Here
let filtered = myNumbers.filter(function(elem) {
	return elem > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(elem) {
	return elem = 'George'
})
//////////////////PROBLEM 19////////////////////
...
// Code Here
let enemies = people.filter(function(elem) {
	if(elem.friend !== true) {
		return elem
	}
})
